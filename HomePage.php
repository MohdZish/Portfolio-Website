    ...
    <body>
      ...
      <! –– Navigation bar -->
        ...
        <div class="container text-center maincontainer">
          <h1 class="jumbotron-heading font-weight-bold" style="color: white">Main Title</h1>
      ...
      <! -- Page Front End -->
        <div class="container projectbg rounded">

          <p class="text-center align-items-center">My Projects</p>
